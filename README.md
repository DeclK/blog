...
12. 公式问题
    ...
    3. 部分公式不显示
       ...
       `\xleftrightarrow` 不显示，查了很多都说是 `ams` 包没有加载，我尝试了很多种方式，都不行。最终这个问题由 Google 搜索引擎间接解决，其给了一个 mathtools 的链接，这是所有的 AI 工具都没有提到的包，最后我根据 [link](https://docs.mathjax.org/en/stable/input/tex/extensions/mathtools.html) 完成配置就 OK 了。
