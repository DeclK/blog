...
本笔记目的在于学习 [Tencent/hpc-ops: High Performance LLM Inference Operator Library](https://github.com/Tencent/hpc-ops) 中对 fp8 kernel 的高效实现。hpc-ops 的特点之一也在其项目 readme 当中提到
